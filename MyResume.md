...
- **職責：**
  ...
  2. 配合財政部、金管會、中央銀行等要求，提前滿足 IFRS、個資保護及 CI/CD 品質需求
...
- **期間：** 2007 - 2010 (3年)  
- **職責：**
  1. 與其它軟體公司合作，提供技術並開發安全管理及電源管理軟體。
  2. 研究軟體工程與流程改進，研究如何提升軟體品質與專案管理效率，並深入了解 CMMI、Extreme Programming、Agile/Scrum 與 DevOps 的演進。

### 資深工程師
- **公司：** 昌曜科技科技股份有限公司 (~100人)  
- **職位：** 資深工程師  
- **地點：** 台北市信義區  
- **期間：** 2003 - 2007 (4年)  
- **職責：**
  1. 負責各種指紋辨識系統的研發，並整合至 Windows 登入系統（整合 GINA 與 Credential Provider）。
  2. 開發掌靜脈辨識系統，並與 Windows 登入系統及工業安控設備整合。
  3. 負責打造雲端廣告播放系統（Digital Signage）。
...
- **期間：** 1998 - 2003 (5年)  
- **職責：**
  1. 大學期間發明 Windows Kernel 技術，透過直接在隔離記憶體建立Call Gate以執行特權指令，研發出頂尖的電源管理軟體，該軟體被美國筆電廠商內建採用，也透過國際軟體及線上發行商推廣販售。
  2. 一直持續領先競爭對手的產品，並獲得國際各雜誌與網站的報導。隨著 Windows XP 的普及，該技術已無法再使用，結束業務。
